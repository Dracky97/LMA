 ...
 */
const calculateCompletedMonths = (joinDate, referenceDate) => {
...
export const calculateLeaveBalances = (employee, leaveRequests = [], year = new Date().getFullYear()) => {
    ...
    // 4. Return Balances
    // FIX: Short Leave Balance = Limit (3 hours/month × 12 months = 36 hours/year) - Used This Year
    // Note: Monthly limit is 3 hours, so annual allowance is 36 hours
    const annualShortLeaveAllowance = LEAVE_CONFIG.SHORT_LEAVE_MONTHLY_LIMIT * 12;
    ...
    return {
        ...
        // Short Leave Balance = Annual Allowance - Used This Year
        shortLeave: Math.max(0, annualShortLeaveAllowance - (usage.shortLeaveThisYear || 0)),
